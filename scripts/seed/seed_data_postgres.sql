...
TRUNCATE TABLE user_referral_codes RESTART IDENTITY CASCADE;
TRUNCATE TABLE zone_surge_rules RESTART IDENTITY CASCADE;
TRUNCATE TABLE subscription_deliveries RESTART IDENTITY CASCADE;
TRUNCATE TABLE support_tickets RESTART IDENTITY CASCADE;
TRUNCATE TABLE settlement_runs RESTART IDENTITY CASCADE;
TRUNCATE TABLE saga_steps RESTART IDENTITY CASCADE;
TRUNCATE TABLE saga_instances RESTART IDENTITY CASCADE;
TRUNCATE TABLE rider_location_updates RESTART IDENTITY CASCADE;
TRUNCATE TABLE rider_earnings RESTART IDENTITY CASCADE;
TRUNCATE TABLE rider_delivery_batch_orders RESTART IDENTITY CASCADE;
TRUNCATE TABLE rider_delivery_batches RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_settlements RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_ratings_summary RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_order_stats RESTART IDENTITY CASCADE;
TRUNCATE TABLE reviews RESTART IDENTITY CASCADE;
TRUNCATE TABLE review_images RESTART IDENTITY CASCADE;
TRUNCATE TABLE promo_banners RESTART IDENTITY CASCADE;
TRUNCATE TABLE promotion_campaigns RESTART IDENTITY CASCADE;
TRUNCATE TABLE order_timeline_events RESTART IDENTITY CASCADE;
TRUNCATE TABLE orders_archive RESTART IDENTITY CASCADE;
TRUNCATE TABLE orders RESTART IDENTITY CASCADE;
TRUNCATE TABLE order_items RESTART IDENTITY CASCADE;
TRUNCATE TABLE order_item_customizations RESTART IDENTITY CASCADE;
TRUNCATE TABLE order_invoices RESTART IDENTITY CASCADE;
TRUNCATE TABLE order_eta_snapshots RESTART IDENTITY CASCADE;
TRUNCATE TABLE order_delivery_proofs RESTART IDENTITY CASCADE;
TRUNCATE TABLE outbox_events RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_versions RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_item_tags RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_item_ratings RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_item_ingredients RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_item_images RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_item_allergens RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_item_additional_images RESTART IDENTITY CASCADE;
TRUNCATE TABLE inventory_alerts RESTART IDENTITY CASCADE;
TRUNCATE TABLE idempotency_records RESTART IDENTITY CASCADE;
TRUNCATE TABLE group_order_participants RESTART IDENTITY CASCADE;
TRUNCATE TABLE group_order_members RESTART IDENTITY CASCADE;
TRUNCATE TABLE group_orders RESTART IDENTITY CASCADE;
TRUNCATE TABLE gift_orders RESTART IDENTITY CASCADE;
TRUNCATE TABLE gift_cards RESTART IDENTITY CASCADE;
TRUNCATE TABLE fraud_review_queue RESTART IDENTITY CASCADE;
TRUNCATE TABLE fraud_events RESTART IDENTITY CASCADE;
TRUNCATE TABLE favorite_restaurants RESTART IDENTITY CASCADE;
TRUNCATE TABLE experiment_exposures RESTART IDENTITY CASCADE;
TRUNCATE TABLE dynamic_pricing_rules RESTART IDENTITY CASCADE;
...
TRUNCATE TABLE data_export_requests RESTART IDENTITY CASCADE;
TRUNCATE TABLE delivery_surveys RESTART IDENTITY CASCADE;
TRUNCATE TABLE customization_choices RESTART IDENTITY CASCADE;
TRUNCATE TABLE customization_options RESTART IDENTITY CASCADE;
TRUNCATE TABLE coupon_usages RESTART IDENTITY CASCADE;
TRUNCATE TABLE coupons RESTART IDENTITY CASCADE;
TRUNCATE TABLE consent_records RESTART IDENTITY CASCADE;
TRUNCATE TABLE churn_scores RESTART IDENTITY CASCADE;
TRUNCATE TABLE city_configs RESTART IDENTITY CASCADE;
TRUNCATE TABLE cart_items RESTART IDENTITY CASCADE;
TRUNCATE TABLE cart_item_customizations RESTART IDENTITY CASCADE;
TRUNCATE TABLE carts RESTART IDENTITY CASCADE;
TRUNCATE TABLE campaign_usages RESTART IDENTITY CASCADE;
TRUNCATE TABLE audit_events RESTART IDENTITY CASCADE;
TRUNCATE TABLE api_keys RESTART IDENTITY CASCADE;
TRUNCATE TABLE agent_cod_wallets RESTART IDENTITY CASCADE;
TRUNCATE TABLE agent_shifts RESTART IDENTITY CASCADE;
TRUNCATE TABLE affiliate_referrals RESTART IDENTITY CASCADE;
TRUNCATE TABLE affiliate_codes RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_features RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_food_types RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_gallery_images RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_gallery RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_cuisines RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_items RESTART IDENTITY CASCADE;
TRUNCATE TABLE menu_categories RESTART IDENTITY CASCADE;
TRUNCATE TABLE customer_notification_preferences RESTART IDENTITY CASCADE;
TRUNCATE TABLE customer_memberships RESTART IDENTITY CASCADE;
...
TRUNCATE TABLE delivery_agents RESTART IDENTITY CASCADE;
TRUNCATE TABLE restaurant_owners RESTART IDENTITY CASCADE;
TRUNCATE TABLE customers RESTART IDENTITY CASCADE;
TRUNCATE TABLE users RESTART IDENTITY CASCADE;
TRUNCATE TABLE cuisines RESTART IDENTITY CASCADE;
...
-- Spice Route (1)
(1,  'ORD-SEED-0001', 'DELIVERED', 488.00, 39.00, 30.00, 0.00, 557.00, 0.00, 0.00, 0, 17, 1, 11, 12, NOW() - INTERVAL \'58 days\', DATE_ADD(NOW() - INTERVAL \'58 days\', INTERVAL 45 MINUTE), 35, 'Less spicy please'),
(2,  'ORD-SEED-0002', 'DELIVERED', 588.00, 47.00, 30.00, 0.00, 665.00, 0.00, 0.00, 0, 19, 1, 15, 13, NOW() - INTERVAL \'49 days\', DATE_ADD(NOW() - INTERVAL \'49 days\', INTERVAL 45 MINUTE), 38, NULL),
(3,  'ORD-SEED-0003', 'DELIVERED', 178.00, 14.00, 30.00, 0.00, 222.00, 0.00, 0.00, 0, 24, 1, 25, 14, NOW() - INTERVAL \'40 days\', DATE_ADD(NOW() - INTERVAL \'40 days\', INTERVAL 45 MINUTE), 32, NULL),
-- Biryani Blues (2)
(4,  'ORD-SEED-0004', 'DELIVERED', 418.00, 33.00, 40.00, 0.00, 491.00, 0.00, 0.00, 0, 20, 2, 17, 15, NOW() - INTERVAL \'52 days\', DATE_ADD(NOW() - INTERVAL \'52 days\', INTERVAL 45 MINUTE), 45, 'Pack raita separately'),
(5,  'ORD-SEED-0005', 'DELIVERED', 368.00, 29.00, 40.00, 0.00, 437.00, 0.00, 0.00, 0, 23, 2, 23, 12, NOW() - INTERVAL \'44 days\', DATE_ADD(NOW() - INTERVAL \'44 days\', INTERVAL 45 MINUTE), 42, NULL),
(6,  'ORD-SEED-0006', 'DELIVERED', 449.00, 36.00, 40.00, 0.00, 525.00, 0.00, 0.00, 0, 26, 2, 29, 13, NOW() - INTERVAL \'37 days\', DATE_ADD(NOW() - INTERVAL \'37 days\', INTERVAL 45 MINUTE), 44, NULL),
-- Dosa Plaza (3)
(7,  'ORD-SEED-0007', 'DELIVERED', 178.00, 14.00, 30.00, 0.00, 222.00, 0.00, 0.00, 0, 18, 3, 13, 14, NOW() - INTERVAL \'46 days\', DATE_ADD(NOW() - INTERVAL \'46 days\', INTERVAL 45 MINUTE), 30, 'Extra sambar'),
(8,  'ORD-SEED-0008', 'DELIVERED', 168.00, 13.00, 30.00, 0.00, 211.00, 0.00, 0.00, 0, 21, 3, 19, 15, NOW() - INTERVAL \'38 days\', DATE_ADD(NOW() - INTERVAL \'38 days\', INTERVAL 45 MINUTE), 28, NULL),
(9,  'ORD-SEED-0009', 'DELIVERED', 249.00, 20.00, 30.00, 0.00, 299.00, 0.00, 0.00, 0, 25, 3, 27, 12, NOW() - INTERVAL \'31 days\', DATE_ADD(NOW() - INTERVAL \'31 days\', INTERVAL 45 MINUTE), 26, NULL),
-- Green Bowl (4)
(10, 'ORD-SEED-0010', 'DELIVERED', 528.00, 42.00, 45.00, 0.00, 615.00, 0.00, 0.00, 0, 22, 4, 21, 13, NOW() - INTERVAL \'47 days\', DATE_ADD(NOW() - INTERVAL \'47 days\', INTERVAL 45 MINUTE), 40, NULL),
(11, 'ORD-SEED-0011', 'DELIVERED', 329.00, 26.00, 45.00, 0.00, 400.00, 0.00, 0.00, 0, 26, 4, 29, 16, NOW() - INTERVAL \'34 days\', DATE_ADD(NOW() - INTERVAL \'34 days\', INTERVAL 45 MINUTE), 42, NULL),
(12, 'ORD-SEED-0012', 'DELIVERED', 698.00, 56.00, 45.00, 0.00, 799.00, 0.00, 0.00, 0, 17, 4, 11, 12, NOW() - INTERVAL \'28 days\', DATE_ADD(NOW() - INTERVAL \'28 days\', INTERVAL 45 MINUTE), 44, NULL),
-- Punjabi Rasoi (5)
(13, 'ORD-SEED-0013', 'DELIVERED', 198.00, 16.00, 39.00, 0.00, 253.00, 0.00, 0.00, 0, 21, 5, 19, 16, NOW() - INTERVAL \'43 days\', DATE_ADD(NOW() - INTERVAL \'43 days\', INTERVAL 45 MINUTE), 30, NULL),
(14, 'ORD-SEED-0014', 'DELIVERED', 139.00, 11.00, 39.00, 0.00, 189.00, 0.00, 0.00, 0, 24, 5, 25, 12, NOW() - INTERVAL \'33 days\', DATE_ADD(NOW() - INTERVAL \'33 days\', INTERVAL 45 MINUTE), 28, NULL),
(15, 'ORD-SEED-0015', 'DELIVERED', 268.00, 21.00, 39.00, 0.00, 328.00, 0.00, 0.00, 0, 19, 5, 15, 14, NOW() - INTERVAL \'26 days\', DATE_ADD(NOW() - INTERVAL \'26 days\', INTERVAL 45 MINUTE), 34, NULL),
-- Coastal Catch (6)
(16, 'ORD-SEED-0016', 'DELIVERED', 528.00, 42.00, 50.00, 0.00, 620.00, 0.00, 0.00, 0, 23, 6, 23, 15, NOW() - INTERVAL \'41 days\', DATE_ADD(NOW() - INTERVAL \'41 days\', INTERVAL 45 MINUTE), 50, NULL),
(17, 'ORD-SEED-0017', 'DELIVERED', 468.00, 37.00, 50.00, 0.00, 555.00, 0.00, 0.00, 0, 18, 6, 13, 12, NOW() - INTERVAL \'29 days\', DATE_ADD(NOW() - INTERVAL \'29 days\', INTERVAL 45 MINUTE), 46, NULL),
(18, 'ORD-SEED-0018', 'DELIVERED', 329.00, 26.00, 50.00, 0.00, 405.00, 0.00, 0.00, 0, 25, 6, 27, 13, NOW() - INTERVAL \'24 days\', DATE_ADD(NOW() - INTERVAL \'24 days\', INTERVAL 45 MINUTE), 42, NULL),
-- Wok Express (7)
(19, 'ORD-SEED-0019', 'DELIVERED', 328.00, 26.00, 39.00, 0.00, 393.00, 0.00, 0.00, 0, 22, 7, 21, 14, NOW() - INTERVAL \'39 days\', DATE_ADD(NOW() - INTERVAL \'39 days\', INTERVAL 45 MINUTE), 30, NULL),
(20, 'ORD-SEED-0020', 'DELIVERED', 398.00, 32.00, 39.00, 0.00, 469.00, 0.00, 0.00, 0, 26, 7, 29, 15, NOW() - INTERVAL \'23 days\', DATE_ADD(NOW() - INTERVAL \'23 days\', INTERVAL 45 MINUTE), 26, NULL),
(21, 'ORD-SEED-0021', 'DELIVERED', 378.00, 30.00, 39.00, 0.00, 447.00, 0.00, 0.00, 0, 20, 7, 17, 12, NOW() - INTERVAL \'18 days\', DATE_ADD(NOW() - INTERVAL \'18 days\', INTERVAL 45 MINUTE), 28, NULL),
-- Tandoori Nights (8)
(22, 'ORD-SEED-0022', 'DELIVERED', 498.00, 40.00, 79.00, 0.00, 617.00, 0.00, 0.00, 0, 23, 8, 23, 15, NOW() - INTERVAL \'36 days\', DATE_ADD(NOW() - INTERVAL \'36 days\', INTERVAL 45 MINUTE), 55, 'Please call on arrival'),
(23, 'ORD-SEED-0023', 'DELIVERED', 438.00, 35.00, 79.00, 0.00, 552.00, 0.00, 0.00, 0, 19, 8, 15, 12, NOW() - INTERVAL \'22 days\', DATE_ADD(NOW() - INTERVAL \'22 days\', INTERVAL 45 MINUTE), 48, NULL),
(24, 'ORD-SEED-0024', 'DELIVERED', 469.00, 38.00, 79.00, 0.00, 586.00, 0.00, 0.00, 0, 26, 8, 29, 13, NOW() - INTERVAL \'16 days\', DATE_ADD(NOW() - INTERVAL \'16 days\', INTERVAL 45 MINUTE), 50, NULL),
-- Bombay Street Food (9)
(25, 'ORD-SEED-0025', 'DELIVERED', 207.00, 17.00, 19.00, 0.00, 243.00, 0.00, 0.00, 0, 17, 9, 11, 14, NOW() - INTERVAL \'35 days\', DATE_ADD(NOW() - INTERVAL \'35 days\', INTERVAL 45 MINUTE), 20, NULL),
(26, 'ORD-SEED-0026', 'DELIVERED', 198.00, 16.00, 19.00, 0.00, 233.00, 0.00, 0.00, 0, 24, 9, 25, 15, NOW() - INTERVAL \'21 days\', DATE_ADD(NOW() - INTERVAL \'21 days\', INTERVAL 45 MINUTE), 22, NULL),
(27, 'ORD-SEED-0027', 'DELIVERED', 178.00, 14.00, 19.00, 0.00, 211.00, 0.00, 0.00, 0, 22, 9, 21, 12, NOW() - INTERVAL \'15 days\', DATE_ADD(NOW() - INTERVAL \'15 days\', INTERVAL 45 MINUTE), 20, NULL),
-- Cafe Milano (10)
(28, 'ORD-SEED-0028', 'DELIVERED', 548.00, 44.00, 49.00, 0.00, 641.00, 0.00, 0.00, 0, 25, 10, 27, 16, NOW() - INTERVAL \'32 days\', DATE_ADD(NOW() - INTERVAL \'32 days\', INTERVAL 45 MINUTE), 40, NULL),
(29, 'ORD-SEED-0029', 'DELIVERED', 528.00, 42.00, 49.00, 0.00, 619.00, 0.00, 0.00, 0, 18, 10, 13, 12, NOW() - INTERVAL \'19 days\', DATE_ADD(NOW() - INTERVAL \'19 days\', INTERVAL 45 MINUTE), 42, NULL),
(30, 'ORD-SEED-0030', 'DELIVERED', 628.00, 50.00, 49.00, 0.00, 727.00, 0.00, 0.00, 0, 20, 10, 17, 13, NOW() - INTERVAL \'12 days\', DATE_ADD(NOW() - INTERVAL \'12 days\', INTERVAL 45 MINUTE), 38, NULL),
-- Marine Plate (11, Mumbai) — shipped to customers' Mumbai addresses
(31, 'ORD-SEED-0031', 'DELIVERED', 638.00, 51.00, 39.00, 0.00, 728.00, 0.00, 0.00, 0, 17, 11, 12, 16, NOW() - INTERVAL \'27 days\', DATE_ADD(NOW() - INTERVAL \'27 days\', INTERVAL 45 MINUTE), 40, 'Medium fry'),
(32, 'ORD-SEED-0032', 'DELIVERED', 649.00, 52.00, 39.00, 0.00, 740.00, 0.00, 0.00, 0, 18, 11, 13, 12, NOW() - INTERVAL \'17 days\', DATE_ADD(NOW() - INTERVAL \'17 days\', INTERVAL 45 MINUTE), 42, NULL),
(33, 'ORD-SEED-0033', 'DELIVERED', 708.00, 57.00, 39.00, 0.00, 804.00, 0.00, 0.00, 0, 25, 11, 27, 14, NOW() - INTERVAL \'9 days\',  DATE_ADD(NOW() - INTERVAL \'9 days\', INTERVAL 45 MINUTE), 38, NULL),
-- Chandni Chowk Chaat Co. (12, Delhi) — shipped to customers' Delhi addresses
(34, 'ORD-SEED-0034', 'DELIVERED', 278.00, 22.00, 29.00, 0.00, 329.00, 0.00, 0.00, 0, 19, 12, 15, 15, NOW() - INTERVAL \'25 days\', DATE_ADD(NOW() - INTERVAL \'25 days\', INTERVAL 45 MINUTE), 26, NULL),
(35, 'ORD-SEED-0035', 'DELIVERED', 248.00, 20.00, 29.00, 0.00, 297.00, 0.00, 0.00, 0, 26, 12, 29, 12, NOW() - INTERVAL \'14 days\', DATE_ADD(NOW() - INTERVAL \'14 days\', INTERVAL 45 MINUTE), 24, NULL),
(36, 'ORD-SEED-0036', 'DELIVERED', 268.00, 21.00, 29.00, 0.00, 318.00, 0.00, 0.00, 0, 18, 12, 14, 13, NOW() - INTERVAL \'5 days\',  DATE_ADD(NOW() - INTERVAL \'5 days\', INTERVAL 45 MINUTE), 28, NULL);
...
(5, 'Butter chicken is the real deal — rich, smoky and perfectly spiced.', 5, 5, 17, 1, 1, 'APPROVED', 'Thank you! Hope to serve you again soon. — Team Spice Route', NOW() - INTERVAL \'57 days\'),
(4, 'Dal makhani was creamy and the paneer was soft.', 4, 4, 19, 2, 1, 'APPROVED', NULL, NOW() - INTERVAL \'48 days\'),
(4, 'Good food, gulab jamun arrived slightly cold though.', 4, 3, 24, 3, 1, 'APPROVED', NULL, NOW() - INTERVAL \'39 days\'),
-- Biryani Blues (2) avg 4.5
(5, 'Best dum biryani in town — saffron rice, tender meat, huge portion.', 5, 5, 20, 4, 2, 'APPROVED', 'Shukriya! Our dum makes the difference. — Biryani Blues', NOW() - INTERVAL \'51 days\'),
(4, 'Veg biryani was flavourful. Double ka meetha is a nice finish.', 4, 4, 23, 5, 2, 'APPROVED', NULL, NOW() - INTERVAL \'43 days\'),
(5, 'Mutton biryani was fall-off-the-bone tender. Packaging leak-proof.', 5, 5, 26, 6, 2, 'APPROVED', NULL, NOW() - INTERVAL \'36 days\'),
-- Dosa Plaza (3) avg 4.2
(4, 'Masala dosa was crisp and the filter coffee is authentic.', 4, 4, 18, 7, 3, 'APPROVED', 'Nandri! Glad you enjoyed. — Dosa Plaza', NOW() - INTERVAL \'45 days\'),
(4, 'Idli and vada were soft and fresh for a delivery order.', 4, 4, 21, 8, 3, 'APPROVED', NULL, NOW() - INTERVAL \'37 days\'),
(4, 'Thali was generous and balanced. Arrived hot.', 4, 4, 25, 9, 3, 'APPROVED', NULL, NOW() - INTERVAL \'30 days\'),
-- Green Bowl (4) avg 4.6
(5, 'Quinoa bowl was fresh and filling — finally healthy food that tastes great.', 5, 5, 22, 10, 4, 'APPROVED', 'Fresh is our promise! — Green Bowl', NOW() - INTERVAL \'46 days\'),
(4, 'Avocado toast was solid; smoothie bowl arrived slightly melted.', 4, 3, 26, 11, 4, 'APPROVED', NULL, NOW() - INTERVAL \'33 days\'),
(5, 'Grilled chicken salad + green juice is my weekly reset meal.', 5, 5, 17, 12, 4, 'APPROVED', NULL, NOW() - INTERVAL \'27 days\'),
-- Punjabi Rasoi (5) avg 4.1
(4, 'Chole bhature just like a Delhi dhaba. Huge portion.', 4, 4, 21, 13, 5, 'APPROVED', NULL, NOW() - INTERVAL \'42 days\'),
(4, 'Amritsari kulcha was perfectly crisp.', 4, 4, 24, 14, 5, 'APPROVED', NULL, NOW() - INTERVAL \'32 days\'),
(4, 'Sarson ka saag tasted seasonal and homely.', 4, 4, 19, 15, 5, 'APPROVED', NULL, NOW() - INTERVAL \'25 days\'),
-- Coastal Catch (6) avg 4.4
(5, 'Prawn ghee roast is a must-try. Appam was soft and lacy.', 5, 5, 23, 16, 6, 'APPROVED', NULL, NOW() - INTERVAL \'40 days\'),
(4, 'Malabar fish curry was tangy and fresh. Neer dosa paired well.', 4, 4, 18, 17, 6, 'APPROVED', NULL, NOW() - INTERVAL \'28 days\'),
(4, 'Chicken stew was comforting. Slightly small portion for the price.', 4, 4, 25, 18, 6, 'APPROVED', NULL, NOW() - INTERVAL \'23 days\'),
-- Wok Express (7) avg 4.0
(4, 'Chilli chicken had the right kick. Manchow soup was comforting.', 4, 4, 22, 19, 7, 'APPROVED', NULL, NOW() - INTERVAL \'38 days\'),
(4, 'Fried rice was well tossed, delivery was quick.', 4, 5, 26, 20, 7, 'APPROVED', NULL, NOW() - INTERVAL \'22 days\'),
(4, 'Manchurian was crispy. Noodles slightly oily.', 4, 4, 20, 21, 7, 'APPROVED', NULL, NOW() - INTERVAL \'17 days\'),
-- Tandoori Nights (8) avg 4.5
(5, 'Tandoori chicken was smoky and juicy. Roomali roti was paper thin.', 5, 5, 23, 22, 8, 'APPROVED', 'Royal thanks! — Tandoori Nights', NOW() - INTERVAL \'35 days\'),
(4, 'Tikka was well marinated. Butter naan arrived warm.', 4, 4, 19, 23, 8, 'APPROVED', NULL, NOW() - INTERVAL \'21 days\'),
(5, 'Rogan josh was rich and aromatic. Worth every rupee.', 5, 5, 26, 24, 8, 'APPROVED', NULL, NOW() - INTERVAL \'15 days\'),
-- Bombay Street Food (9) avg 4.3
(5, 'Vada pav tastes exactly like Dadar station. Nostalgia in every bite.', 5, 5, 17, 25, 9, 'APPROVED', NULL, NOW() - INTERVAL \'34 days\'),
(4, 'Pav bhaji was buttery goodness and cutting chai is a steal.', 4, 5, 24, 26, 9, 'APPROVED', NULL, NOW() - INTERVAL \'20 days\'),
(4, 'Frankie roll was well spiced. Pani puri could be spicier.', 4, 4, 22, 27, 9, 'APPROVED', NULL, NOW() - INTERVAL \'14 days\'),
-- Cafe Milano (10) avg 4.4
(5, 'Wood-fired margherita is the closest to Naples in this city.', 5, 4, 25, 28, 10, 'APPROVED', 'Grazie mille! — Cafe Milano', NOW() - INTERVAL \'31 days\'),
(4, 'Farmhouse pizza loaded well. Cappuccino travelled surprisingly well.', 4, 4, 18, 29, 10, 'APPROVED', NULL, NOW() - INTERVAL \'18 days\'),
(4, 'Aglio olio was garlicky and light. Lava cake was molten as promised.', 4, 4, 20, 30, 10, 'APPROVED', NULL, NOW() - INTERVAL \'11 days\'),
-- Marine Plate (11) avg 4.2
(5, 'Crab sukka is phenomenal — fiery, fresh and generous.', 5, 5, 17, 31, 11, 'APPROVED', 'Thanks for the love! — Marine Plate', NOW() - INTERVAL \'26 days\'),
(4, 'Tawa pomfret was perfectly cooked. Solkadhi soothed the spice.', 4, 4, 18, 32, 11, 'APPROVED', NULL, NOW() - INTERVAL \'16 days\'),
(4, 'Prawn pulao was flavourful, Bombay duck fry was a novelty.', 4, 4, 25, 33, 11, 'APPROVED', NULL, NOW() - INTERVAL \'8 days\'),
-- Chandni Chowk Chaat Co. (12) avg 4.5
(5, 'Aloo paratha with white butter — pure Old Delhi magic.', 5, 5, 19, 34, 12, 'APPROVED', 'Dil se shukriya! — Chandni Chowk Chaat Co.', NOW() - INTERVAL \'24 days\'),
(5, 'Chole bhature was huge and the rabri falooda is the best dessert delivered.', 5, 5, 26, 35, 12, 'APPROVED', NULL, NOW() - INTERVAL \'13 days\'),
(4, 'Dahi bhalla was fresh and chutneys balanced. Quick delivery too.', 4, 5, 18, 36, 12, 'APPROVED', NULL, NOW() - INTERVAL \'4 days\');
...
(17, 3,  1,  5, 'Butter chicken was outstanding', NOW() - INTERVAL \'57 days\'),
(17, 6,  1,  4, 'Garlic naan could be more garlicky', NOW() - INTERVAL \'57 days\'),
(19, 4,  2,  5, 'Dal makhani was creamy', NOW() - INTERVAL \'48 days\'),
(24, 9,  3,  4, 'Gulab jamun was warm and sweet', NOW() - INTERVAL \'39 days\'),
(20, 11, 4,  5, 'Perfect dum biryani', NOW() - INTERVAL \'51 days\'),
(23, 12, 5,  4, 'Veg biryani was flavourful', NOW() - INTERVAL \'43 days\'),
(26, 13, 6,  5, 'Mutton biryani was tender', NOW() - INTERVAL \'36 days\'),
(18, 18, 7,  4, 'Crisp dosa, generous filling', NOW() - INTERVAL \'45 days\'),
(21, 23, 9,  4, 'Thali was balanced', NOW() - INTERVAL \'30 days\'),
(22, 25, 10, 5, 'Best quinoa bowl around', NOW() - INTERVAL \'46 days\'),
(17, 26, 12, 4, 'Good grilled chicken salad', NOW() - INTERVAL \'27 days\'),
(21, 30, 13, 4, 'Bhature were fluffy', NOW() - INTERVAL \'42 days\'),
(23, 36, 16, 5, 'Prawn ghee roast was stellar', NOW() - INTERVAL \'40 days\'),
(26, 44, 20, 4, 'Fried rice was well tossed', NOW() - INTERVAL \'22 days\'),
(23, 51, 22, 5, 'Tandoori chicken was smoky perfection', NOW() - INTERVAL \'35 days\'),
(17, 58, 25, 5, 'Vada pav = nostalgia', NOW() - INTERVAL \'34 days\'),
(25, 65, 28, 5, 'Wood-fired crust was excellent', NOW() - INTERVAL \'31 days\'),
(17, 75, 31, 4, 'Pomfret was fresh', NOW() - INTERVAL \'26 days\'),
(18, 77, 32, 5, 'Crab sukka worth every penny', NOW() - INTERVAL \'16 days\'),
(19, 80, 34, 5, 'Parathas like Dilli', NOW() - INTERVAL \'24 days\'),
(26, 81, 35, 4, 'Solid chole bhature', NOW() - INTERVAL \'13 days\'),
(18, 84, 36, 5, 'Rabri falooda was divine', NOW() - INTERVAL \'4 days\');
