...
import com.bhukkad.identity.infrastructure.ratelimit.LoginLockoutProperties;
...
@EnableConfigurationProperties({PlatformJwtProperties.class, ServiceAuthProperties.class,
        com.bhukkad.identity.infrastructure.ratelimit.LoginLockoutProperties.class})
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Swagger/docs are served by identity; restrict to non-prod via
                        // gateway route or feature flag in production overlays.
