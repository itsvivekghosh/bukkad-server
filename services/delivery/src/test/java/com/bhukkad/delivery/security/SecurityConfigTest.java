 ...
 * active. The public serviceability GETs stay permitAll on delivery.
 */
@SpringBootTest(properties = "app.auth.jwt.secret=0123456789abcdef0123456789abcdef")
class SecurityConfigTest extends AbstractDeliveryPostgresTest {
