...
import com.bhukkad.notification.AbstractNotificationPostgresTest;
 ...
 * active (all notification endpoints require a token).
 */
@SpringBootTest(properties = "app.auth.jwt.secret=0123456789abcdef0123456789abcdef")
class SecurityConfigTest extends AbstractNotificationPostgresTest {
