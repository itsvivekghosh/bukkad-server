-- notification service schema - consolidated baseline (fresh start).
...
--
-- Name: idx_notifications_channel_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_notifications_channel_status ON public.notifications USING btree (channel, status);
...
CREATE INDEX idx_notifications_recipient ON public.notifications USING btree (recipient, created_at);
