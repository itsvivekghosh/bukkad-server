...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, String> producerFactory(ExternalEventsProperties properties) {
    ...
    @Bean
    public ConsumerFactory<String, String> consumerFactory(ExternalEventsProperties properties) {
        Map<String, Object> config = new HashMap<>();
