package com.bhukkad.common.outbox.mapper;

import com.bhukkad.common.outbox.DeadLetterEvent;
import com.bhukkad.common.dto.response.DeadLetterEventResponse;

/**
 * Maps dead-letter entities to their admin-facing response. Lives beside the
 * entity (not on the DTO) so the DTO package stays free of persistence-package
