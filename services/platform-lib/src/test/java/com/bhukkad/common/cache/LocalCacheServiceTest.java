...
class LocalCacheServiceTest {
    ...
    private LocalCacheService build(boolean enabled, int ttlSeconds) {
        ...
        return new LocalCacheService(props, new com.bhukkad.common.cache.StampedeProperties());
    }
    ...
    @Test void probabilisticEarlyExpiration_treatsNearExpiryEntryAsMiss() throws Exception {
        ...
        com.bhukkad.common.cache.StampedeProperties stampede = new com.bhukkad.common.cache.StampedeProperties();
