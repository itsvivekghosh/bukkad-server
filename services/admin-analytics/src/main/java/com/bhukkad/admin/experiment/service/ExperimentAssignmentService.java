 ...
 *
 * <p>Ported verbatim from the monolith's
 * {@code com.bhukkad.experiment.ExperimentAssignmentService}: the hashing and
 * bucketing math is a deterministic contract and must not be changed.</p>
 */
@Slf4j
@Service
