...
class WebhookTransitionMatrixTest {
    ...
    @Mock private com.bhukkad.payment.idempotency.PaymentScopeIdempotencyRepository paymentScopeIdempotencyRepository;
    @Mock private OutboxClient outboxClient;
    @Mock private com.bhukkad.payment.gateway.PaymentGateway paymentGateway;
