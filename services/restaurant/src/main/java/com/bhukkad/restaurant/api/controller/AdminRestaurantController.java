...
public class AdminRestaurantController {
    ...
    public java.util.List<com.bhukkad.restaurant.domain.entity.Review> moderationQueue(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "20") int size) {
        return reviewRepository
                .findByStatusOrderByCreatedAtDesc(com.bhukkad.restaurant.domain.entity.Review.STATUS_PENDING,
    ...
    @Transactional
    public com.bhukkad.restaurant.domain.entity.Review approveReview(
        ...
        review.setStatus(com.bhukkad.restaurant.domain.entity.Review.STATUS_APPROVED);
