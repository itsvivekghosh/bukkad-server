...
import com.bhukkad.restaurant.domain.service.impl.DynamicPricingService;
...
public class MenuCategoryCompatController {
    ...
    private final com.bhukkad.restaurant.domain.repository.MenuItemRepository menuItemRepository;
    ...
    public Map<String, Object> deleteCategory(@AuthenticationPrincipal TokenPrincipal principal,
        ...
        MenuCategory category = menuCategoryRepository.findById(categoryId)
                .orElseThrow(() -> new ResourceNotFoundException("Category not found: " + categoryId));
        ownerGuard.requireOwnerOrAdmin(principal, category.getRestaurantId());
        List<com.bhukkad.restaurant.domain.entity.MenuItem> items =
