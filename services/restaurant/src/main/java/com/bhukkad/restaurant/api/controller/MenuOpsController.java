...
public class MenuOpsController {
    ...
    private final com.bhukkad.restaurant.domain.service.impl.DynamicPricingService pricingService;
    ...
    private com.bhukkad.restaurant.domain.entity.MenuCategory menuCategory(Long categoryId) {
    ...
    private final com.bhukkad.restaurant.domain.repository.MenuCategoryRepository menuCategoryRepository;
}
